...
import type { SmokeDensity } from '../metadata/metadata.types.ts';
...
// deployment. Only smoke_density is deployed so far; the other three indicator
// functions don't exist yet because their deployments don't either.
