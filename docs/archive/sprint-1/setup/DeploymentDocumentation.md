> **Archived 2026-09-24.** Historical record, kept as written. Current version: [Deployment and operations](../../../live/deployment-and-operations.md), [Development setup](../../../live/dev-setup.md). Why things changed: [decision log](../../../decisions/decision-log.md).
...
# 4. Create a project and deployment space, from the right starting point
