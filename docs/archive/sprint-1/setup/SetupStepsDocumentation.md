> **Archived 2026-09-24.** Historical record, kept as written. Current version: [Development setup](../../../live/dev-setup.md). Why things changed: [decision log](../../../decisions/decision-log.md).
