> **Archived 2026-09-24.** Historical record, kept as written. Current version: [Requirements](../../../../live/requirements.md). Why things changed: [decision log](../../../../decisions/decision-log.md).
