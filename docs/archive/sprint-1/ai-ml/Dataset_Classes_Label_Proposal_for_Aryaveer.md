> **Archived 2026-09-24.** Historical record, kept as written. Current version: [Severity rubric](../../../live/severity-rubric.md), [AI models and dataset](../../../live/ai-models-and-dataset.md). Why things changed: [decision log](../../../decisions/decision-log.md).
